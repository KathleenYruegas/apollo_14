...
describe "When I visit /astronauts" do
  before(:each) do
    ...
    @space_mission_1 = @astro_1.space_missions.create(title: "Jupiter")
    @space_mission_2 = @astro_1.space_missions.create(title: "Mars")
    @space_mission_3 = @astro_1.space_missions.create(title: "Apollo")
    @space_mission_4 = @astro_2.space_missions.create(title: "Mars")
    @space_mission_5 = @astro_2.space_missions.create(title: "Jupiter")
    @space_mission_6 = @astro_2.space_missions.create(title: "Apollo")
    @space_mission_7 = @astro_3.space_missions.create(title: "Mars")
    @space_mission_8 = @astro_3.space_missions.create(title: "Jupiter")
  end
